...
geom_histogram(bins = 6, position = "dodge", color = "black") +
  ...
  x = "", fill = "Player", caption = "Source: https://fbref.com")
```
###  Goalkeeper: Alisson
...
##  Attackers
The firepower of Liverpool FC and the goalscorers of any team.
...
geom_col(position = "dodge")+
  theme_classic()+
  labs(title = "The Highehst Scoring Liverpool FC Front Three", 
